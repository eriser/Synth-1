//==============================================================================
//
//   Linux VST Synth PluginProcessor.h
//
//==============================================================================
...
class NewProjectAudioProcessor  : public AudioProcessor
{
 public:
  ...
  //==============================================================================
  //   Pointer to AudioSampleBuffer aka "pointer->connector"

  AudioSampleBuffer *input;
    
  AudioSampleBuffer *connector;
  ...
  float mtof[128] = { 8.1757989156,     8.6619572180,     9.1770239974,     9.7227182413
                      ...
                      ,10548.0818212118, 11175.3034058561, 11839.8215267723, 12543.853951435
  };
 private:
  //==============================================================================
